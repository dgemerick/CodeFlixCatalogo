...
public class UpdateCategoryTest
{
    ...
    public async Task UpdateCategoryWithoutIsActive(DomainModel.Category exampleCategory, UpdateCategoryInput exampleInput)
    {
    ...
    public async Task UpdateCategoryOnlyName(DomainModel.Category exampleCategory, UpdateCategoryInput exampleInput)
    {
